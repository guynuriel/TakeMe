            ...
            if (this.state.password2 === this.state.password3) {
                ...
                if (data.find(d => d.username === this.state.username2.toLowerCase()) === undefined) {
                    ...
                    const user = {
                        ...
                        userimage: "https://firebasestorage.googleapis.com/v0/b/react-drawer.appspot.com/o/images%2Fimages.png?alt=media&token=3c6268ef-087b-4186-8a20-307435c6d74c",
                        favorites: [],
                        chats: []
                    }
