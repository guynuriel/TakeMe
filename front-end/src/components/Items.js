...
class Items extends Component {
    ...
    favorite = async (e) => {
        if (localStorage.username) {
            ...
            else { swal("Item is alredy exist in your favorite's list") }
    ...
    render() {
        ...
        return (
            <div  >
                ...
                <input id="favs-input" placeholder="Search" name="input" type="text" value={this.state.input} onChange={this.update} />
                        ...
                        <div className="card">
                            ...
                            <div className="info">
                                <div className="precio">
                                    ...
                                    <span className="total"> <span className="total-edit" contenteditable>Uploaded By : {m.name}</span></span>
